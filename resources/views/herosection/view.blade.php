        ...
        <div class="card">
          ...
          <div class="card-header card-header-content-md-between">
              <div class="mb-2 mb-md-0">
                  <h4 class="card-header-title">View text</h4>
              </div>
              <div class="mb-2 mb-md-0">
                  <form>
                      <!-- Search -->
              ...
              <table id="datatable"
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="table-column-ps-0">
                        <div class="ms-3">
                          <span class="d-block h5 text-inherit mb-0">{{$item->subtitle}}</span>
                        </div>
                      </td>
                      @if(isset($url['scheme']))
                      <td class="email"><img class="avatar-img" src="{{$item->bannerimg}}" height="50px" width="50px"></td>
                      @else
                      <td class="email"><img class="avatar-img" src="{{asset('public/herosection/'.$item->bannerimg)}}" height="50px" width="50px"></td>
                      @endif
                      <td class="table-column-ps-0">
                          <div class="ms-3">
                            <span class="d-block h5 text-inherit mb-0">{{$item->bgtext}}</span>
                          </div>
                      </td>
                    </tr>
                    @empty
