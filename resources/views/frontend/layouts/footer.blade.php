  ...
  <div class="mt-auto max-2xl:max-w-7xl 2xl:px-24 3xl:px-36  px-6 lg:px-8 w-full py-6 lg:pt-20 mx-auto">
    <div class="grid grid-cols-3 sm:grid-cols-6 md:grid-cols-12 gap-6">
      <div class="col-span-3">
        <a class="[filter:contrast(0)brightness(2)] flex-none inline-block max-sm:h-16 max-w-40 text-xl font-semibold text-white focus:outline-none focus:opacity-80" href="{{ url('/') }}" aria-label="Brand">
          <img src="{{asset('/public/tailwind_frontend/logo1.png')}}" alt="logo" class="w-full h-full">
        </a>
        <div class="">
          <p class="text-gray-400 text-base 2xl:text-lg 3xl:text-2xl py-5">
        ...
        <div class="w-full flex flex-wrap items-center gap-2 pt-3">
          <ul class="flex  ">
            <li class="list-none">
              <a href="https://www.instagram.com/flixaura/" target="_blank" class="relative sm:size-10 size-9 bg-white text-center leading-[80px] text-[35px] mx-2 flex items-center justify-center rounded-md p-2 overflow-hidden border-3 border-white duration-300 group overflow-hidden border-2 border-white">
            ...
            <li class="list-none">
              <a href="https://www.facebook.com/flixauraindia" target="_blank" class="relative sm:size-10 size-9 bg-white text-center leading-[80px] text-[35px] mx-2 flex items-center justify-center rounded-md p-3 overflow-hidden border-3 border-white duration-300 group overflow-hidden border-2 border-white">
            ...
            <!-- <li class="list-none">
              <a href="#" class="relative sm:size-10 size-9 bg-white text-center leading-[80px] text-[35px] mx-2 flex items-center justify-center rounded-md p-2 overflow-hidden border-3 border-white duration-300 group overflow-hidden border-2 border-white">
            ...
            <li class="list-none">
              <a href="https://www.youtube.com/@Flixaura_wed" target="_blank" class="relative sm:size-10 size-9 bg-white text-center leading-[80px] text-[35px] mx-2 flex items-center justify-center rounded-md p-2 overflow-hidden border-3 border-white duration-300 group overflow-hidden border-2 border-white">
      ...
      <div class="col-span-3 md:mx-auto">
        <h4 class="font-semibold text-gray-100 text-base 2xl:text-lg 3xl:text-2xl">Quick Links</h4>
      ...
      <div class="col-span-3 md:mx-auto">
        <h4 class="font-semibold text-gray-100 text-base 2xl:text-lg 3xl:text-2xl">Useful Links</h4>
      ...
      <div class="col-span-3">
        <h4 class="font-semibold text-gray-100 text-base 2xl:text-lg 3xl:text-2xl">Contact Us</h4>

        <div class="mt-3">
          <ul class="gap-3 flex flex-col">
            <li>
              <a href="tel:9887034345" class="flex items-center gap-x-2 text-gray-400 hover:text-gray-200 focus:outline-none focus:text-gray-200 text-base 2xl:text-lg 3xl:text-2xl"> <span class="">
                ...
                </span> +91-98870 34345</a>
            </li>
            <li>
              <a href="mailto:flixaura@gmail.com" class="flex items-center gap-x-2 text-gray-400 hover:text-gray-200 focus:outline-none focus:text-gray-200 text-base 2xl:text-lg 3xl:text-2xl"> <span class="">
                ...
                </span> flixaura@gmail.com</a>
            </li>
            <li>
              <div href="javascript:;" class="flex items-center gap-x-2 text-gray-400 hover:text-gray-200 focus:outline-none focus:text-gray-200 text-base 2xl:text-lg 3xl:text-2xl"> <span class="">
