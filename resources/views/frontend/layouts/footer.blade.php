    ...
    <div class="grid grid-cols-3 sm:grid-cols-6 md:grid-cols-12 gap-6">
      <div class="col-span-3">
        ...
        <div class="w-full flex flex-wrap items-center gap-2 pt-3">
          <ul class="flex">
            <li class="list-none">
              <a href="//{{ $mediaUrl->instaUrl}}" class="relative size-10 bg-white text-center leading-[80px] text-[35px] mx-2 flex items-center justify-center rounded-md p-2 overflow-hidden border-3 border-white duration-300 group overflow-hidden border-2 border-white">
            ...
            <li class="list-none">
              <a href="//{{ $mediaUrl->facebookUrl }}" target="_blank" class="relative size-10 bg-white text-center leading-[80px] text-[35px] mx-2 flex items-center justify-center rounded-md p-3 overflow-hidden border-3 border-white duration-300 group overflow-hidden border-2 border-white">
            ...
            <li class="list-none">
              <a href="//{{ $mediaUrl->twitterUrl }}" class="relative size-10 bg-white text-center leading-[80px] text-[35px] mx-2 flex items-center justify-center rounded-md p-2 overflow-hidden border-3 border-white duration-300 group overflow-hidden border-2 border-white">
            ...
            <li class="list-none">
              <a href="//{{ $mediaUrl->youtubeUrl }}" class="relative size-10 bg-white text-center leading-[80px] text-[35px] mx-2 flex items-center justify-center rounded-md p-2 overflow-hidden border-3 border-white duration-300 group overflow-hidden border-2 border-white">
