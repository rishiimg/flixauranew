    ...
    <div class="topHeader flex items-center justify-between group-[]/nav:hidden">
      <div class="md:flex hidden">
        <ul class="flex items-center gap-3">
          <li> 
            <a class="size-5 text-white" href="//{{ $mediaUrl->facebookUrl }}" target="_blank">
          ...
          <li>
            <a class="size-5 text-white" href="//{{ $mediaUrl->twitterUrl }}" target="_blank">
          ...
          <li>
            <a class="size-5 text-white" href="//{{ $mediaUrl->instaUrl}}" target="_blank">
          ...
          <li>
            <a class="size-5 text-white" href="//{{ $mediaUrl->emailUrl }}" target="_blank">
              <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
