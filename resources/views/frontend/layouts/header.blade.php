  ...
  <header class="mx-auto max-w-7xl lg:px-8 px-6">
    <div class="topHeader flex items-center justify-between group-[]/nav:hidden">
      <div class="md:flex hidden">
        ...
        <ul class="flex  ">
          <li class="list-none">
            <a href="https://www.instagram.com/flixaura/" target="_blank"  class="relative size-7 bg-white text-center leading-[80px] text-[35px] mx-1 flex items-center justify-center rounded-md p-1 overflow-hidden border-2 border-white duration-300 group overflow-hidden border-2 border-white">
          ...
          <li class="list-none">
            <a href="https://www.facebook.com/flixauraindia" target="_blank" class="relative size-7 bg-white text-center leading-[80px] text-[35px] mx-1 flex items-center justify-center rounded-md p-1.5 overflow-hidden border-2 border-white duration-300 group overflow-hidden border-2 border-white">
          ...
          <li class="list-none">
            <a href="https://www.youtube.com/@Flixaura_wed" target="_blank" class="relative size-7 bg-white text-center leading-[80px] text-[35px] mx-1 flex items-center justify-center rounded-md p-1 overflow-hidden border-2 border-white duration-300 group overflow-hidden border-2 border-white">
      ...
      <div class="flex items-center ">
        ...
        <a href="{{route('website.contact_us')}}" class="relative px-5 py-2 font-medium text-white group md:flex hidden">
...
<div class=" fixed flex flex-col h-screen inset-y-0 right-0 z-[1011] w-full overflow-y-auto bg-gradient-to-b from-gray-950 to-sky-950 select-none text-white  sm:max-w-sm sm:ring-1 sm:ring-gray-900/10 peer-checked/sideToggle:translate-x-0 peer-checked/sideToggle:opacity-100 translate-x-full opacity-0 duration-300">
  ...
  <div class="flex flex-col overflow-hidden h-full w-full relative z-10 ms-auto">
    <div class="flex items-center justify-between p-3 bg-slate-950">
      ...
      <div>
        <label for="sideToggle" type="button" class="-m-2.5 rounded-md p-2.5 text-gray-200 flex h-auto">
    ...
    <div class="relative flex w-full p-3 flex-auto overflow-y-auto flex-col z-20 bg-white">
      <ul>
          ...
          <div class="w-full peer-checked/mm:block hidden">
            <div class="grid grid-cols-1 flex-wrap w-full gap-4">
              <div class="w-full text-sm xl:text-base *:flex *:items-center *:gap-x-3 *:py-1 *:relative">
                <div>
                  <div class="flex-auto">
                    <a href="{{route('services.haldi') }}" class="block font-semibold  text-slate-950/70 px-2">
                      Haldi
                    </a>
                  </div>
                </div>
                <div>
                  ...
                  <div class="flex-auto">
                    <a href="{{route('services.mehendi') }}" class="block font-semibold  text-slate-950/70 px-2">
                      Mehendi
                ...
                <div>
                  ...
                  <div class="flex-auto">
                    <a href="{{route('services.engagement') }}" class="block font-semibold  text-slate-950/70 px-2">
                      Engagement
                ...
                <div>
                  ...
                  <div class="flex-auto">
                    <a href="{{route('services.wedding-photography') }}" class="block font-semibold  text-slate-950/70 px-2">
                      Wedding Photography
                ...
                <div>
                  ...
                  <div class="flex-auto">
                    <a href="{{route('services.candid-photography') }}" class="block font-semibold  text-slate-950/70 px-2">
                      Candid Photography
                ...
                <div class=" border-b ">
                  ...
                  <div class="flex-auto pb-3">
                    <a href="{{route('services.pre-wedding-photoshoot') }}" class="block font-semibold  text-slate-950/70 px-2">
        ...
        <li>
          <a class="flex items-center gap-2 border-b group relative px-2 py-1.5 w-full text-slate-950/70 hover:text-slate-950 text-sm font-semibold" href="{{route('website.gallery') }}">Gallery</a>
        </li>
        <li>
          <a class="flex items-center gap-2 border-b group relative px-2 py-1.5 w-full text-slate-950/70 hover:text-slate-950 text-sm font-semibold" href="{{route('website.blog') }}">Blog</a>
        </li>
        <li>
          <a class="flex items-center gap-2 border-b group relative px-2 py-1.5 w-full text-slate-950/70 hover:text-slate-950 text-sm font-semibold" href="{{route('website.contact_us')}}">Contact Us</a>
        </li>
        <li>
