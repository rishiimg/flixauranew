...
<div class="max-w-7xl mx-auto px-6 lg:px-8 py-10 sm:pt-20">
...
<section class="max-w-7xl mx-auto px-6 lg:px-8 sm:py-10 sm:pt-20 pt-10">
  <div class="uppercase text-5xl  max-sm:text-start relative  text-balance flex sm:items-center sm:justify-center  w-full font-bold text-slate-800 sm:pb-14  mx-auto">Blogs<div class="absolute sm:-top-7 -top-4 [font-family:Yesteryear] [-webkit-text-stroke:_0.8px_#000] opacity-40 text-transparent xl:text-[120px] sm:text-[90px] text-[50px] font-light">Latest Blogs</div>
</div>
<div class="py-12 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12">
  <a class="group flex flex-col focus:outline-none" href="/blog-details">
