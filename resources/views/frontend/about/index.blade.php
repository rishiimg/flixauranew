  ...
  <div class="grid md:grid-cols-2  items-center md:gap-10 gap-5">
    <div class="">
      <div class="sm:text-5xl text-4xl relative  text-balance  w-full font-bold text-theme1 md:pb-14 mb-8">
        VISION
        <div class="-z-10 absolute sm:-top-7 -top-3 [font-family:Yesteryear] [-webkit-text-stroke:_0.8px_#000] opacity-40 text-transparent md:text-[120px] sm:text-[90px] text-[80px] font-light">OUR</div>
      </div>
