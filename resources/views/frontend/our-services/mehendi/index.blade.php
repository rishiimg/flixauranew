    ...
    <div class="grid grid-cols-12 items-center sm:gap-y-10 gap-y-5 lg:gap-8 ">
      ...
      <div data-aos="fade-left" class="col-span-12 lg:col-span-6 ">
        <div class="size-full">
          ...
          Planning a Mehandi ceremony bursting with color and joy? Wedding Photography By FlixAura can turn your dream into a vibrant reality!
          </div>
          <div data-aos="zoom-out-up" class="sm:text-base text-sm mt-4 text-slate-600 text-balance ">
          We know how much these special moments filled with laughter and love mean to you. Do you envision a celebration brimming with Deepika Padukone’s grace or crave a touch of Priyanka Chopra’s playful energy? We’ll capture your one-of-a-kind style with artistic flair.
          </div>
          <div data-aos="zoom-out-up" class="sm:text-base text-sm mt-4 text-slate-600 text-balance ">
          Our expert photographers are masters of capturing genuine emotions. They’re also bursting with creative ideas, inspired by the latest trends, to create stunning poses that perfectly suit you. Relax and immerse yourself in the beauty of the intricate henna designs being applied, while we ensure these cherished memories are preserved forever.
          </div>
        </div>
      </div>
