...
<section class="h-[70vh] bg-no-repeat bg-cover bg-center bg-[url('{{asset('/public/tailwind_frontend/haldi.webp')}}')] relative before:absolute before:bg-black/50 before:inset-0 before:z-10 before:size-full">
  <div class="mx-auto max-w-7xl lg:px-8 px-6 h-full py-10 relative z-20">
    <div class="text-white sm:text-7xl text-5xl flex items-end justify-center h-full">HALDI</div>
  </div>
</section>
      ...
      <div data-aos="fade-left" class="col-span-12 lg:col-span-6 ">
        <div class="size-full">
          ...
          <div data-aos="zoom-out-up" class="sm:text-base text-sm mt-4 text-slate-600 text-balance ">
            Dreaming of a colorful Haldi ceremony filled with joy and laughter, just like those unforgettable movie moments? FlixAura is here to make it a reality! While we’re seasoned experts in wedding photography, when it comes to capturing the lively energy of a Haldi, we turn into passionate storytellers.
          </div>
          <div data-aos="zoom-out-up" class="sm:text-base text-sm mt-4 text-slate-600 text-balance ">
            Every celebration tells a unique story, and your Haldi is no different. It’s a moment to create unforgettable memories with your loved ones, wrapped in laughter and fun. Imagine capturing those candid moments—the playful teasing as your sibling covers you in Haldi paste or the joyful chaos of an impromptu water splash from your friends. We’re always ready, capturing every heartfelt laugh and unexpected moment so that your memories are preserved forever.
          </div>
          <div data-aos="zoom-out-up" class="sm:text-base text-sm mt-4 text-slate-600 text-balance ">
            If you’re picturing a Haldi bursting with life and laughter, we’re here to make it happen! Let’s bring your vision to life with the perfect mix of joy, spontaneity, and beautiful photography.
          </div>
        </div>
      </div>
