        ...
        <div class="card">
            ...
            <div class="card-header card-header-content-md-between">
                ...
                <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
                    <!-- Datatable Info -->
                    <div id="datatableCounterInfo" style="display: none;">2
            ...
            <div class="table-responsive datatable-custom position-relative">
                <table id="datatable"
                    ...
                    <tbody>
                                ...
                                <td>
                                    @if ($item->image != '')
                                        @php
                                            ...
                                            $simage = $img[0];
                                        @endphp
                                <td class="email"><img class="avatar-img" src="{{ asset('public/gallery/' . $simage) }}"
                        ...
                        <td>
                            <a href="{{route('image.edit',$item->id)}}" class="btn btn-primary">Edit</a>
                            <a href="{{route('image.delete',$item->id)}}" class="btn btn-danger">Delete</a>
                        </td>
                        </tr>
